...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/resources/propertiesfile/config.properties");//src/test/java/resources/propertiesfile/config.properties
